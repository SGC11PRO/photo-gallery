...
const fotos = [
  ...
  {
    id: 8,
    src: '/photos/Nature_08.png',
    titulo: 'At the world´s end',
    categoria: 'Nature',
    descripcion: 'The End?',
  },
  {
    id: 9,
    src: '/photos/Nature_09.png',
          ...
          <div className='gallery-grid'>
            {cargando ? (
              ...
              fotosFiltradas.map((foto) => (
                ...
                >
                  <Image src={foto.src || '/images/placeholder.webp'} alt={foto.titulo} width={400} height={300} />
